...
<body>
    ...
    <div class="property-summary page-container">
        <div class="row no-gutters justify-content-between">
            <?php
            $total_rating = ($property['rating_cleanliness'] + $property['rating_food'] + $property['rating_safety']) / 3;
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    <div class="rating-criteria row">
                        ...
                        <div class="rating-criteria-star-container col-6" title="<?= $property['rating_cleanliness'] ?>">
                            <?php
                            $rating = $property['rating_cleanliness'];
                            for ($i = 0; $i < 5; $i++) {
                                if ($rating >= $i + 0.8) {
                            ?>
                                    <i class="fas fa-star"></i>
